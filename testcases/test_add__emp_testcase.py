...
class Test_Adddd_Emp():
    ...
    def test_add_emp_003(self,setup):
        ...
        self.obj2.test_ebter_first_name('Sonal') ;

        self.log.info("ENTERING MIDDLE NAME") ;
        self.obj2.test_enter_middle_name('B') ;
        time.sleep(2)

        self.log.info("ENTERING THE LAST NAME") ;
        self.obj2.test_enter_last_name('Shinde')
        time.sleep(2)
        ...
        if (self.obj2.test_print_success_msg() == True):
            ...
            self.driver.save_screenshot(
                "D:\\pythonProject1\\pythonProject1\\pythonProject\\Orange HRM Project\\screenshots\\add_emp_003_pass.png");
            ...
            allure.attach(self.driver.get_screenshot_as_png(), name="add_emp_003_fail.png",
                          attachment_type=AttachmentType.PNG)
            self.driver.save_screenshot(
                "D:\\pythonProject1\\pythonProject1\\pythonProject\\Orange HRM Project\\screenshots\\add_emp_003_fail.png");
            assert False;
